...
# Priority order used when multiple flags fire — the first matching
# flag decides the headline action. Lower-priority context still gets
# folded into the decision text below it.
FLAG_PRIORITY = [
    "VEHICLE_NOT_FOUND",
    "LOW_SOC",
    "UNASSIGNED_HIGHWAY",
